...
#include "/usr/people/include/Trace.h"
		/* Trace.h alleen nodig voor enkele toolboxitems */
...
/*   ********  NOTES  ***********	*****************************
	...
	- de funktie traces_qread eventueel vervangen
...
short tbpat[16], oldmap[4][3], oldcursor;
...
/* ADD TOPICS */
			...
			if(G.ebase==0) {
				switch(y) {
					case 0: tbstr= "Plane";		tbstr1= "A";	tbval=1; break;
					case 1: tbstr= "Cube";		tbstr1= "A";	tbval=91; break;
					case 2: tbstr= "Camera";	tbstr1= "A";	tbval=4; break;
					case 3: tbstr= "Nurbs";		tbstr1= "A";	tbval=5; break;
					case 4: tbstr= "Lamp";		tbstr1= "A";	tbval=2; break;
					case 5: tbstr= "Curve";		tbstr1= "A";	tbval=11; break;
					case 6: tbstr= "Text";		tbstr1= "A";	tbval=9; break;
					case 7: tbstr= "Move";		tbstr1= "A";	tbval= -2; break;
					case 8: tbstr= "";			tbstr1= "";		break;
					case 9: tbstr= "Ika";		tbstr1= "A";	tbval= -4; break;
					case 10: tbstr= "Duplicate";tbstr1= "D";	break;
					case 11: tbstr= "";			tbstr1= "";		break;
				}
				if(tbstr1[0]=='A') tbfunc= (void (*)() )addbase;
			}
			else if(G.ebase->soort==1) {		
				switch(y) {
				...
				if(tbstr1[0]=='A') tbfunc= addprimitiveVV;
			}
			else if(G.ebase->soort==5) {
				switch(y) {
				...
				if(tbstr1[0]=='A') tbfunc= addprimitiveNurb;
			}
			else if ELEM(G.ebase->soort, 11, -2) {
				switch(y) {
				...
				if(tbstr1[0]=='A') tbfunc= addprimitiveCurve;
			}
			else if(G.ebase->soort== -4) {
				switch(y) {
					case 0: tbstr= "Rod";		tbstr1= "A";	tbval=1; break;
					case 1: tbstr= "Chain";		tbstr1= "A";	tbval=5; break;
					case 2: tbstr= "T Rod";		tbstr1= "A";	tbval=2; break;
					case 3: tbstr= "";			tbstr1= "";		break;
					case 4: tbstr= "H Rod";		tbstr1= "A";	tbval=3; break;
					case 5: tbstr= "";			tbstr1= "";		break;
					case 6: tbstr= "Q Rod";		tbstr1= "A";	tbval=4; break;
					case 7: tbstr= "";			tbstr1= "";		break;
					case 8: tbstr= "";			tbstr1= "";		break;
					case 9: tbstr= "";			tbstr1= "";		break;
					case 10: tbstr= "Duplicate";tbstr1= "D";	break;
				...
				if(tbstr1[0]=='A') tbfunc= addprimitiveIka;
			}
		}
...
/* NURBS TOPICS */
			...
			switch(y) {
				...
				case 6: tbstr= "PrintWeights";	tbstr1= "w";	break;
				case 7: tbstr= "SelectRow";		tbstr1= "R";	break;
				case 8: tbstr= "ToggleHandle";	tbstr1= "h";	break;
				case 9: tbstr= "Auto Handle";	tbstr1= "H";	break;
				case 10: tbstr= "Vect Handle";	tbstr1= "v";	break;
				case 11: tbstr= "BestHandles";	tbstr1= "c|h";	break;
			}
		}
...
/* IKA TOPICS */
			...
			switch(y) {
				case 0: tbstr= "Connect";	tbstr1= "k";	break;
				case 1: tbstr= "Split";		tbstr1= "y";	break;
				case 2: tbstr= "Make Joint";tbstr1= "j";	break;
				case 3: tbstr= "Make sKeleton";	tbstr1= "K";break;
				case 4: tbstr= "";	tbstr1= "";	break;
				case 5: tbstr= "";	tbstr1= "";	break;
				case 6: tbstr= "";	tbstr1= "";	break;
				case 7: tbstr= "";	tbstr1= "";	break;
...
void toolbox()
{
	...
	while(1) {
		event= 0;
		if(qtest()) event= traces_qread(&val);
...
char *title, *item;
{
	...
	xmax= (short) fmgetstrwidth(helv10, item);
	len= (short) fmgetstrwidth(helv10, title);
