...
extern struct ImBuf *loadamiga(long *,long);
extern struct ImBuf *loadcdi(long *,long);
extern struct ImBuf *loadanim(long *,long);
extern struct ImBuf *loadtarga(uchar *,long);
extern struct ImBuf *loadiris(uchar *,long);
extern struct ImBuf *loadtim(ushort *,long);
extern struct ImBuf *loadjpeg(char *,long);
