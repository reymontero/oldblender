...
void face_select()
{
	...
	lrectread(mval[0]+curarea->winrct.xmin, mval[1]+curarea->winrct.ymin, mval[0]+curarea->winrct.xmin, mval[1]+curarea->winrct.ymin, &col);
...
void face_borderselect()
{
	...
	if(val) {
		...
		rt=rectm= mallocN(4*sx*sy, "selrect");
		lrectread(rect.xmin+curarea->winrct.xmin, rect.ymin+curarea->winrct.ymin, rect.xmax+curarea->winrct.xmin, rect.ymax+curarea->winrct.ymin, rectm);
