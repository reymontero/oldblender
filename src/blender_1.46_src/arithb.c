...
void Mat4MulFloat3(float m[][4], float f)		/* alleen de scale component */
{
	long i,j;
...
ulong hsv_to_cpack(float h, float s, float v)
{
	short r, g, b;
	float rf, gf, bf;
	ulong col;
...
ulong rgb_to_cpack(float r, float g, float b)
{
	int ir, ig, ib;
...
void cpack_to_rgb(ulong col, float *r, float *g, float *b)
{
	char *cp;
